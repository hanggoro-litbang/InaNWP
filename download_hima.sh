...
cd ${hima_dir}/${yyyy1}${mm1}${dd1}${cc}
       ...
       if [ -e ${hima_dir}/${yyyy1}${mm1}${dd1}${cc}/NC_H09_${yyyy1}${mm1}${dd1}_${cc}00_R21_FLDK.02401_02401.nc ]; then
               ...
               wget --user=user --password='password' ftp://ftp.ptree.jaxa.jp/jma/netcdf/${yyyy1}${mm1}/${dd1}/NC_H09_${yyyy1}${mm1}${dd1}_${cc}00_R21_FLDK.02401_02401.nc
       fi
       ...
       if [ -e ${hima_dir}/${yyyy1}${mm1}${dd1}${cc}/NC_H09_${yyyy1}${mm1}${dd1}_${cc}00_L2CLP010_FLDK.02401_02401.nc ]; then
               ...
               echo "Download Cloud Product"
                wget --user=user --password='password' ftp://ftp.ptree.jaxa.jp/pub/himawari/L2/CLP/010/${yyyy1}${mm1}/${dd1}/${cc}/NC_H09_${yyyy1}${mm1}${dd1}_${cc}00_L2CLP010_FLDK.02401_02401.nc
       fi
exit 0
